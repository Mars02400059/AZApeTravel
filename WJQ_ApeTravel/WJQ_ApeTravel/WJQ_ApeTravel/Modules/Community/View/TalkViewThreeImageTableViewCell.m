//
//  TalkViewThreeImageTableViewCell.m
//  WJQ_ApeTravel
//
...
@interface TalkViewThreeImageTableViewCell ()
...
@implementation TalkViewThreeImageTableViewCell
...
- (void)layoutSubviews {
    ...
    _rightImageView.frame = CGRectMake(X + (imageViewWidth + 20) * 2, imageViewY, imageViewWidth, imageViewWidth);
    _leftImageView.layer.cornerRadius = 3.f;
    _leftImageView.clipsToBounds = YES;
    _centerImageView.layer.cornerRadius = 3.f;
    _centerImageView.clipsToBounds = YES;
    _rightImageView.layer.cornerRadius = 3.f;
