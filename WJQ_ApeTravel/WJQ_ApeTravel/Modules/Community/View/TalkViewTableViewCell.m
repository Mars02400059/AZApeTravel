...
@interface TalkViewTableViewCell ()
...
- (void)layoutSubviews {
    ...
    CGFloat forumY = Y + _authorLabel.height + _titleLabel.height;
    CGFloat Height = 50.f;
    ...
    _backLabel.frame = CGRectMake(0, Y + _authorLabel.height + _titleLabel.height + Height, self.width, 10);
