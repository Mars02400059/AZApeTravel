...
- (void)asyncLoadData:(NSString *)urlString {
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        [manager GET:url parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
            ...
            [AZType AZTypeCacensWritePatchCachePatch:@"controllerEnter.plist" cacheDic:responseObject];
            ...
            NSDictionary *responseObject = [azType AZTypeGetTakeCachePatch:@"controllerEnter.plist"];
