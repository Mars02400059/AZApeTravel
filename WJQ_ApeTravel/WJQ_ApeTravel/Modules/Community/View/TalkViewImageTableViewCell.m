...
@interface TalkViewImageTableViewCell ()
...
@implementation TalkViewImageTableViewCell
...
- (void)layoutSubviews {
    ...
    _reply_timeLabel.frame = CGRectMake(X + Width / 2, forumY, 100, Height);
    UIImageView *shijian = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"手表"]];
    shijian.frame = CGRectMake(-16, 18, 14, 14);
    [_reply_timeLabel addSubview:shijian];
    
    _reply_numLabel.frame = CGRectMake(self.width - 50, forumY, 30, Height);
    UIImageView *xiaoxi  = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"消息"]];
    xiaoxi.frame = CGRectMake(-18, 18, 14, 14);
    [_reply_numLabel addSubview:xiaoxi];
