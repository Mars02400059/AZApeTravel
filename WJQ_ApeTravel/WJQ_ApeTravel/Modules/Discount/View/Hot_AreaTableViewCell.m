...
- (void)myButtonAction {
    ...
    [self.delegate AZ_areaButtonActionType:_hotArea.type typeName:_hotArea.typeName];
...
- (void)setHotArea:(HotArea *)hotArea {
    ...
    _myLabel.text = hotArea.typeName;
    [_myButton setTitle:[NSString stringWithFormat:@"查看%@专区", hotArea.typeName] forState:UIControlStateNormal];
