...
- (void)setHot_goodsArrayModel:(HotGoodsArrayModel *)hot_goodsArrayModel {
    _hot_goodsArrayModel = hot_goodsArrayModel;
    [_hotgoodsArray removeAllObjects];
    [_hotgoodsArray addObjectsFromArray:hot_goodsArrayModel.hot_goodsArray];
