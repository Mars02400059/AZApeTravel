...
@interface LookAllTwoTableViewCell ()
/**
 *  占位装饰品
 */
...
@implementation LookAllTwoTableViewCell
...
- (void)myButtonAction:(UIButton *)myButton {
    [self.dataSource AZ_transmitInfoAndSpringInspanPageTable];
}
